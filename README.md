...
These are the paper's descriptive five-fold subject-level results, not results regenerated by this minimal repository:
...
The paper describes these as the highest **mean** scores among the audited comparators. It does not claim universal or statistically significant superiority.
